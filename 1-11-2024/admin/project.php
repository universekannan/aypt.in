                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered table-striped" id="dataTables-example">
                        ...
                        if($_SESSION['user_type']=="admin"){
                            $sql = "select * from galaxy_project where status='Active'";
                        }else{
                            $user_id=$_SESSION['user_id'];
                            $sql = "select a.*,b.description from galaxy_project a,galaxy_category b where a.category_id=b.id and a.id in(select project_id from galaxy_rights where user_id=$user_id) order by category_id and follow_up='$date' and trim(latest_update)<>''";
                        }
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tr>
							    ...
							    </td>                                 <td><a class="btn btn-info fa fa-eye"
