...
if (isset($_POST['submit'])) {
    ...
    pro_old_balance=?,status=?,latest_update=?,follow_up=? where id=?");
    $stmt->bind_param("sssssssssssi", $category_id, $project_name, $website_url, $email, $mobile, $address, $amount, $pro_old_balance=$amount,$status, $latest_update, $follow_up,$id);
    $stmt->execute();

    header("location: live-project.php");
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $row['mobile']; ?>" type="text" maxlength="100"
                                    ...
                                    <div class="col-md-12 text-center">
                                        ...
                                        <a href="live-project.php" class="btn btn-info">Back</a>
                                    </div>
                                </div>
                            </div>
                        </form>
