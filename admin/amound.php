            ...
            <div class="row">
               <div class="col-md-12" style="padding-bottom: 5px" >
                        ...
                        while ($row2 = mysqli_fetch_assoc($result2)) {
                            ?>
                    <a href="add-amound.php?id=<?php echo $row2['id']; ?>" class="btn btn-info fa fa-plus pull-right">&nbsp;Add Amound</a>
                    <br>
                </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
						...
						<tr style="background-color: steelblue;color:white">
                            <th style="text-align: center" colspan="12"><?php echo $row2['project_name']; ?> Rs <?php echo $row2['amount']; ?></th>	
							<?php } ?>
